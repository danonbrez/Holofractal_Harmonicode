...
APP_IMPORT = "hhs_backend.runtime_os_application_server:app"
APP_MODULE_RELATIVE = Path("hhs_backend/runtime_os_application_server.py")
HEALTH_PATH = "/health"
ZERO_SHA256 = "0" * 64
...
'''
    ...
    def supervised_command(
        ...
        *,
        ...
        module_path = repository / APP_MODULE_RELATIVE
        if not module_path.is_file():
            raise Pass184Error(
                "P184_REJECT_APPLICATION_MODULE_MISSING",
                "current Runtime OS application module is missing",
...
def write_completion_receipt(path: str | os.PathLike[str], checks: Mapping[str, bool]) -> dict[str, Any]:
    payload: dict[str, Any] = {
        "schema": "HHS_PASS_184_I142_LOCAL_COMPLETION_RECEIPT_V1",
        "classification": "HHS_PASS_184_I142_LOCAL_ACCEPTANCE_VERIFIED",
        "contract": CONTRACT_ID,
        ...
        "independent_hash72_clock": False,
        "hash216_archival_only": True,
        "terminal_pass184_completion_claimed": False,
    }
    ...
    payload["completion_receipt_hash72"] = hash72_digest(
        {"domain": "HHS-PASS184-I142-LOCAL-COMPLETION-V1"},
        canonical,
    )
    payload["evidence_set_hash216"] = Hash216Genome.root(
        Hash216Genome.positions(canonical, previous_root=ZERO_HASH216, sequence=142)
    )

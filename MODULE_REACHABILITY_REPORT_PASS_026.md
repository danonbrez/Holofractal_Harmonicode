...
```json
{
  ...
  "GUI_REACHABLE": 2,
  "PLUGIN_READY": 352,
  "SERVICE_REACHABLE": 33
}
```

## Canonical Surfaces

- Services discovered: **23**
- API routes discovered: **18**
- GUI runtime surfaces discovered: **2**
- Orphan records: **0**
- Plugin-ready candidates: **352**
- Pass 025 integration decisions: **609**
...
| … | … | 252 additional records omitted from this summary; see JSON manifest. |
...
```json
{
  "canonical_payload": "\"{\\\"api_route_count\\\": 18, \\\"orphan_count\\\": 0, \\\"record_count\\\": 717, \\\"schema\\\": \\\"HHS_RUNTIME_REACHABILITY_MANIFEST_V1\\\", \\\"service_count\\\": 23, \\\"status_counts\\\": {\\\"API_REACHABLE\\\": 9, \\\"BOOT_REACHABLE\\\": 14, \\\"DOCUMENTED_ONLY\\\": 307, \\\"GUI_REACHABLE\\\": 2, \\\"PLUGIN_READY\\\": 352, \\\"SERVICE_REACHABLE\\\": 33}, \\\"version\\\": \\\"PASS_026\\\"}\"",
  "digest": "A9foFMKE7<2*T+riz((OkIg3lUyJHMEV(LX5RKbHoUXa83uCg*trkpcAd<2GB92KYToQ<JCB",
  "dna": "A9foFMKE7<2*T+riz((OkIg3lUyJHMEV(LX5RKbHoUXa83uCg*trkpcAd<2GB92KYToQ<JCB",

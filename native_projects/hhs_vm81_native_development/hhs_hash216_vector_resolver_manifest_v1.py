    ...
    result = stable(
        {
            ...
            "resolver": {
                "construction": "BUILD_COMPLETE_CANDIDATE_VALIDATE_SORT_COMMIT_ROOT_THEN_PUBLISH",
                "published_snapshot_mutable": False,
            ...
            "closure": {
                ...
                "immutable_resolver_snapshot_implemented": True,
                ...
                "no_partial_publication_implemented": True,

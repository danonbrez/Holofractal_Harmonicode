...
from hhs_backend_final_certification_v1 import (
    HHSBackendFinalCertificationV1
)
...
from hhs_runtime.harmonicode_interpreter_v1 import (
    interpret
)

from hhs_runtime.harmonicode_constraint_solver_v1 import (
    solve_interpreter_result
)
...
from hhs_runtime.hhs_convergence_packet_v1 import (
    build_convergence_packet
)

from hhs_runtime.hhs_agent_patch_planner_v1 import (
    plan_transformation_patch
)

from hhs_runtime.hhs_branch_to_equation_manifest_v1 import (
    select_and_bind_equation_manifest
)

from hhs_runtime.hhs_ir_transpiler_v1 import (
    transpile_manifest
)
...
APP_NAME = (
    "HHS Runtime API Server v1"
)

ARTIFACT_ROOT = Path(
    "demo_reports/runtime_api"
)
...
def _calculator_evaluation_payload(
    ...
    solved = solve_interpreter_result(
        interpreted
    )
    ...
    return {
        ...
        "correctionBranchFrontier":
            branch_frontier.to_dict(),
...
async def api_calculator_evaluate(
    ...
    req: CalculatorEvaluateRequest

) -> Dict[str, Any]:

    return _calculator_evaluation_payload(

...
- Working branch: `agent/pass210-kimi-k3-native-llm`
- Merge target: `main`
- Contract: `HHS-P210-KIMI-K3-AGENTIC-SWARM-LITERT-LM-GEMMA4-NATIVE-AGI-OPTIMIZER-DIGITALOCEAN`
...
- Repointed `/api/assistant` to the Pass 210 hierarchy.
...
- Parse the Pass 210 contract JSON.
...
- `/var/lib/hhs/pass210/PASS210_LLM_PREFLIGHT_RECEIPT.json`;

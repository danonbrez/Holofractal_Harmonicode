...
# Executable controls are derived from the two frozen primitives above. Human-facing
# evidence may print fewer trailing digits, but the control itself must not introduce
# an independent rounded constant.
GAMMA_BASIS_REF = R_REF * H_ADDR
GAMMA_ROUTE_REF = GAMMA_BASIS_REF * Decimal(4)
GAMMA_QUDIT_REF = R_REF * Decimal(72)
GAMMA_VM_REF = R_REF * Decimal(36)

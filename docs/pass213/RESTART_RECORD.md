...
- Restart evidence lineage begins at `f58497cbecaf85f15ea173b4ac3ff8a59d77a75a`; later restart-only commits remain non-runtime evidence and are excluded from the dedicated workflow.
- Merge target: `main`

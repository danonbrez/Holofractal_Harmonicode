...
int main(){
 ...
 using P184=CumulativePassGlobalDefaults<184>; using P183=CumulativePassGlobalDefaults<183>; using P182=CumulativePassGlobalDefaults<182>; using P181=CumulativePassGlobalDefaults<181>;
 static_assert(P184::global_defaults_required&&P183::global_defaults_required&&P182::global_defaults_required&&P181::global_defaults_required);
 static_assert(P181::repair_forward_on_gap&&!P181::standalone_application&&!P181::optional_cross_cutting_defaults);

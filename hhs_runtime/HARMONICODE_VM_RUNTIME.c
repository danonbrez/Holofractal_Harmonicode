...
EDGER=FROZEN
CG18
PREV:    2jDWVX51QbuxI6>1pQ0y?oVxa4BELNQR2Q8ki)vi9X3tFrzLuC5JxQBpOUVm(ARNW8cEOYMW
STATE:   EYavwAcdQcwAMb3cxQ1A2s-DhcBFNQUuNrTWUA2*UAaBFsBOyHbQFQCtRY-s1IRRYbgfpznr
RECEIPT: cVzbjxzEONoD!3(fQybgrehO>(Y3qDSBZphEI9j4Phf4s9y)qP(b<yd0F-1cBWkoo5mVdFpL
WITNESS: cl:O cl:K HALT [FROZEN]
XYZW: [0 9 9 0]  bal=0
HALTED

---- RUN CLOSURE SUMMARY ----
Transport   closure ever reached : no
Orientation closure ever reached : YES
Constraint  closure ever reached : YES
Identity gate ever passed        : no
Joint CONVERGED at some step     : no
Tensor layer count               : 2
Genomic layer                    : [1 12 14 71]

"""Compatibility adapter between the canonical slotted runtime state and storage.

Persistence and replay surfaces inherited computed state attributes from the
pre-slotted state model. The adapter restores those deterministic projections
without adding a parallel state object or executing runtime logic.
"""
...
from hhs_python.runtime.hhs_runtime_state import HHSRuntimeState

...
integrated application-factory API, the native storybook-reel studio, and the
Pass 161 Holofractal Harmonizer static application. The canonical server
remains the runtime authority; this module only changes HTTP projection.
"""

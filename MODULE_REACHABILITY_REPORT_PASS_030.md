...
```json
{
  ...
  "GUI_REACHABLE": 2,
  "PLUGIN_READY": 354,
  "SERVICE_REACHABLE": 35
}
```

## Canonical Surfaces

- Services discovered: **25**
- API routes discovered: **18**
- GUI runtime surfaces discovered: **2**
- Orphan records: **0**
- Plugin-ready candidates: **354**
- Pass 025 integration decisions: **626**
...
| `hhs_runtime/hhs_authorized_execution_failure_policy_v1.py` | `hhs_runtime.hhs_authorized_execution_failure_policy_v1` | registered guarded service: authorized_execution_failure_policy.self_test |
| `hhs_runtime/hhs_authorized_pure_function_executor_v1.py` | `hhs_runtime.hhs_authorized_pure_function_executor_v1` | registered guarded service: authorized_pure_function_executor.self_test |
| `hhs_runtime/hhs_contract_schema_registry_v1.py` | `hhs_runtime.hhs_contract_schema_registry_v1` | registered guarded service: contract_schema_registry.self_test |
| `hhs_runtime/hhs_controlled_live_plugin_executor_v1.py` | `hhs_runtime.hhs_controlled_live_plugin_executor_v1` | registered guarded service: controlled_live_plugin_executor.self_test |
| `hhs_runtime/hhs_dryrun_live_plugin_executor_v1.py` | `hhs_runtime.hhs_dryrun_live_plugin_executor_v1` | registered guarded service: dryrun_live_plugin_executor.self_test |
...
| `hhs_runtime/hhs_readonly_live_plugin_adapter_v1.py` | `hhs_runtime.hhs_readonly_live_plugin_adapter_v1` | registered guarded service: readonly_live_plugin_adapter.self_test |
...
| … | … | 254 additional records omitted from this summary; see JSON manifest. |
...
```json
{
  "canonical_payload": "\"{\\\"api_route_count\\\": 18, \\\"orphan_count\\\": 0, \\\"record_count\\\": 740, \\\"schema\\\": \\\"HHS_RUNTIME_REACHABILITY_MANIFEST_V1\\\", \\\"service_count\\\": 25, \\\"status_counts\\\": {\\\"API_REACHABLE\\\": 9, \\\"BOOT_REACHABLE\\\": 14, \\\"DOCUMENTED_ONLY\\\": 326, \\\"GUI_REACHABLE\\\": 2, \\\"PLUGIN_READY\\\": 354, \\\"SERVICE_REACHABLE\\\": 35}, \\\"version\\\": \\\"PASS_030\\\"}\"",
  "digest": "A9foFMKE7<2*T*koz((OkIg3lUyJHMEV(NY)YKbHqSXa83uCg*trkpcAd<2IA82KYToQ<JCB",
  "dna": "A9foFMKE7<2*T*koz((OkIg3lUyJHMEV(NY)YKbHqSXa83uCg*trkpcAd<2IA82KYToQ<JCB",

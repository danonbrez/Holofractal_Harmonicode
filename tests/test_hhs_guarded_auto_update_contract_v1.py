...
def test_digitalocean_workflow_builds_frontend_in_github_and_transfers_exact_bundle() -> None:
    ...
    required = [
        ...
        "HHS Lane 5 BIOS Unified VM Supervisor",
        "manage-unified-vm.sh start",
        "runtime_os_attached",
        "single_vm81_authority_preserved",
        "readlink -f \"$BUNDLE_ROOT/current\"",
        "ServerAliveInterval=30",
        "ServerAliveCountMax=20",
        "host application listener on 8080 remains after unified VM cutover",
        "http://127.0.0.1:18080/api/interface/status",

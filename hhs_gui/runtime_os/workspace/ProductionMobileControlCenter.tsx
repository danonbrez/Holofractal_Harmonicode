    ...
    <main data-testid="production-mobile-control-center" className="mx-auto max-w-6xl space-y-3 p-3 pb-24 md:p-5">
      <section className="rounded-3xl border border-neutral-800 bg-neutral-900/50 p-4 md:p-5">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <div className="text-[10px] uppercase tracking-[0.24em] text-cyan-500">System & data</div>
            <h2 className="mt-1 text-lg font-semibold text-white">Runtime, files and production tools</h2>
            <p className="mt-2 max-w-2xl text-xs leading-5 text-neutral-400">Quick Build above is the normal development path. Use this section for runtime status, multimodal file ingestion, vector-store readback, visual programming and governed production operations.</p>
          </div>

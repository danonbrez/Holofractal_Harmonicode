...
def stale_remote_result_disposition_v1_self_test():
    base = partition_tolerant_federated_recovery_self_test()
    return {"schema": "HHS_STALE_REMOTE_RESULT_DISPOSITION_V1_SELF_TEST_V1", "ok": base["ok"], "run_root_hash72": base["run_root_hash72"]}

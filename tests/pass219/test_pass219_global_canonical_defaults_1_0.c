...
int main(void){
 ...
 assert(p.wired_ceiling_pass==218U&&p.wired_floor_pass==180U&&p.registered_binding_count==41U);
 ...
 assert(hhs_exact_pass219_global_canonical_defaults_binding_at(41U,&k)==HHS_EXACT_STATUS_RANGE_ERROR);
 return 0;
}

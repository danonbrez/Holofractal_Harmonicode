...
```json
{
  ...
  "GUI_REACHABLE": 2,
  "PLUGIN_READY": 555,
  "SERVICE_REACHABLE": 326
}
```

## Canonical Surfaces

- Services discovered: **317**
- API routes discovered: **81**
- GUI runtime surfaces discovered: **2**
- Orphan records: **0**
- Plugin-ready candidates: **555**
- Pass 025 integration decisions: **1346**
...
| … | … | 266 additional records omitted from this summary; see JSON manifest. |
...
| … | … | 455 additional records omitted from this summary; see JSON manifest. |
...
```json
{
  "canonical_payload": "\"{\\\"api_route_count\\\": 81, \\\"orphan_count\\\": 0, \\\"record_count\\\": 1882, \\\"schema\\\": \\\"HHS_RUNTIME_REACHABILITY_MANIFEST_V1\\\", \\\"service_count\\\": 317, \\\"status_counts\\\": {\\\"API_REACHABLE\\\": 12, \\\"BOOT_REACHABLE\\\": 14, \\\"DEPRECATED\\\": 1, \\\"DOCUMENTED_ONLY\\\": 972, \\\"GUI_REACHABLE\\\": 2, \\\"PLUGIN_READY\\\": 555, \\\"SERVICE_REACHABLE\\\": 326}, \\\"version\\\": \\\"PASS_032\\\"}\"",
  "digest": "db2wz*s4eXLs?Tbfk9+Rh6Wts9(!xDPvcNfB7htBhkfPLsq4cfKRZHr+8vo0++?jG0S4gLbN",
  "dna": "db2wz*s4eXLs?Tbfk9+Rh6Wts9(!xDPvcNfB7htBhkfPLsq4cfKRZHr+8vo0++?jG0S4gLbN",

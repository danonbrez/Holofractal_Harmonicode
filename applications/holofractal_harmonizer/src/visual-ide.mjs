...
$('#ide-ingest').onclick = ingest; $('#ide-interpret').onclick = interpret; $('#ide-compile').onclick = compile; $('#ide-run').onclick = run; $('#ide-run-lifecycle').onclick = () => void runBoundedProjectTest().catch(() => {}); $('#ide-replay').onclick = replay; $('#ide-egress').onclick = exportEgress; $('#ide-download-egress').onclick = exportEgress;
const commands = { new: createFile, save: saveFile, ingress: ingest, interpret, compile, run, lifecycle: runBoundedProjectTest, egress: exportEgress };

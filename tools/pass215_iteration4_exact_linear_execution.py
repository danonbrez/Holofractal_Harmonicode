#!/usr/bin/env python3
"""CLI for Pass 215 Iteration 4 exact one-layer linear execution evidence."""
...
def main() -> int:
    ...
    if args.validate is not None:
        ...
        result = {
            "schema": "HHS_PASS_215_ITERATION_4_LINEAR_EXECUTION_VALIDATION_V1",
            "valid": True,
        ...
        print("PASS215_ITERATION4_EVIDENCE_VALID")
        return 0
    ...
    if args.compare_replay is not None:
        ...
        result = {
            "schema": "HHS_PASS_215_ITERATION_4_CROSS_PROCESS_REPLAY_VALIDATION_V1",
            "valid": True,
        ...
        _write(args.output, result)
        print("PASS215_ITERATION4_CROSS_PROCESS_REPLAY_VALID")
        return 0
    ...
    print(f"PASS215_ITERATION4_SINGLE_DELTA_WORK={aggregate['single_region_continuation_work']['executed_work_units_total']}")
    print(f"PASS215_ITERATION4_SINGLE_FULL_WORK={aggregate['single_region_full_recompute_control_work']['executed_work_units_total']}")
    print(f"PASS215_ITERATION4_MULTI_DELTA_WORK={aggregate['multi_region_continuation_work']['executed_work_units_total']}")
    print(f"PASS215_ITERATION4_MULTI_FULL_WORK={aggregate['multi_region_full_recompute_control_work']['executed_work_units_total']}")
    ...
    print("PASS215_ITERATION4_EXACT_LINEAR_EXECUTION_OK")
    return 0

...
int main(void){
 ...
 assert(p.wired_ceiling_pass==218U&&p.wired_floor_pass==177U&&p.registered_binding_count==44U);
 ...
 assert(hhs_exact_pass219_global_canonical_defaults_binding_at(44U,&k)==HHS_EXACT_STATUS_RANGE_ERROR);
 return 0;
}

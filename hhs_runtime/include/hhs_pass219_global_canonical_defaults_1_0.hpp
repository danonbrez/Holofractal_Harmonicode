...
public:
 ...
 static constexpr bool global_compression_debt_policy_required() noexcept { return HHS_EXACT_PASS219_GLOBAL_COMPRESSION_DEBT_DEFAULT_REQUIRED == 1U; }
 ...
 static HHSExactStatus validate_compression_debt_policy() noexcept { return hhs_exact_pass219_global_canonical_defaults_validate_compression_debt_policy(); }
...
static_assert(GlobalCanonicalDefaults::global_compression_debt_policy_required());
}
#endif

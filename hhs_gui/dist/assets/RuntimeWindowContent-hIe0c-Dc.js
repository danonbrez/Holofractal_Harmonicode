const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HHSCalculatorSurface-TEj-EqT6.js","assets/main-BzENKgnW.js","assets/index-w4d0Ryph.js","assets/main-TbVV-tzM.css","assets/HHSCalculatorGraphProjection-B9sDxA8l.js","assets/HHSRuntimeBreadboard-BUe2t6UY.js","assets/HHSRuntimeTransportOverlay-C1fBTSyi.js"])))=>i.map(i=>d[i]);
import{_ as l}from"./index-w4d0Ryph.js";import{j as n,r as c,R as s}from"./main-BzENKgnW.js";async function a(e,r){try{return await e()}catch(t){return console.error("[RuntimeWindowContent] optional runtime surface missing",t),{default:r}}}const d=s.lazy(()=>a(()=>l(()=>import("./HHSCalculatorSurface-TEj-EqT6.js"),__vite__mapDeps([0,1,2,3])),v)),x=s.lazy(()=>a(()=>l(()=>import("./HHSCalculatorGraphProjection-B9sDxA8l.js"),__vite__mapDeps([4,1,2,3])),g)),f=s.lazy(()=>a(()=>l(()=>import("./HHSRuntimeBreadboard-BUe2t6UY.js"),__vite__mapDeps([5,1,2,3])),_)),m=s.lazy(()=>a(()=>l(()=>import("./HHSRuntimeTransportOverlay-C1fBTSyi.js"),__vite__mapDeps([6,1,2,3])),w)),R=({runtimeOS:e,applicationId:r})=>r==="runtime_console"?n.jsx(p,{runtimeOS:e}):r==="calculator"?n.jsx(c.Suspense,{fallback:n.jsx(i,{label:"calculator"}),children:n.jsxs("div",{className:`
                        w-full
                        h-full
                        grid
                        grid-cols-2
...
//# sourceMappingURL=RuntimeWindowContent-hIe0c-Dc.js.map

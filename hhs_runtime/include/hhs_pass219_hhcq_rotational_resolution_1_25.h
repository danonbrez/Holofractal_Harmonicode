...
#define HHS_EXACT_PASS219_HHCQ_PARAMETER_COUNT HHS_EXACT_VM81_FRAME_BITS
#define HHS_EXACT_PASS219_HHCQ_PHASE_MODULUS HHS_EXACT_PASS219_CORE_CIRCUIT_PHASE_MODULUS
#define HHS_EXACT_PASS219_HHCQ_DIVISOR_COUNT UINT32_C(35)
#define HHS_EXACT_PASS219_HHCQ_TRINARY_STEP HHS_EXACT_PASS219_CORE_CIRCUIT_UPDATE_QUANTUM

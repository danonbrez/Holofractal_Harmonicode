...
typedef struct HHSExactPass219H36VMStateV1 {
    ...
    uint8_t legacy_user_mode;
    uint8_t legacy_user_io;
    uint8_t legacy_user_io_trap;
    uint8_t legacy_interrupt_cycle;
    uint8_t legacy_last_io_interrupt_cycle;
    uint8_t legacy_priority_enabled_mask;

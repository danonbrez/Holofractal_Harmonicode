...
PASS219_RML20_RNA_VM5184_SRC := hhs_runtime/cpp/hhs_pass219_rml20_rna_vm5184_bridge_1_34.cpp
PASS219_RML20_RNA_VM5184_OBJ := $(RUNTIME_BUILD_DIR)/pass219/hhs_pass219_rml20_rna_vm5184_bridge_1_34.o
PASS219_VM81_AUTHORITY_EXPORT_MAP := hhs_runtime/c/hhs_pass219_vm81_authority_exports.map

PASS169_RUNTIME_BINDING_SRCS += \
	$(PASS219_PQC_CELL_WALL_OBJ) \
	$(PASS219_RNA_VM5184_ABI_OBJ) \
	$(PASS219_RML20_RNA_VM5184_OBJ)
...
$(PASS219_RML20_RNA_VM5184_OBJ): $(PASS219_RML20_RNA_VM5184_SRC) \
		hhs_runtime/include/hhs_pass219_rml20_rna_vm5184_bridge_1_34.h \
		hhs_runtime/include/hhs_pass219_rna_vm5184_abi_1_33.h \
		hhs_runtime/include/hhs_pass219_core_holographic_four_lane_1_24.h | $(RUNTIME_BUILD_DIR)
	mkdir -p $(dir $@)
	$(CXX) $(CXXFLAGS) -fPIC -c $(PASS219_RML20_RNA_VM5184_SRC) -o $@

$(ABI_LIB): \
	$(PASS219_PQC_CELL_WALL_OBJ) \
	$(PASS219_RNA_VM5184_ABI_OBJ) \
	$(PASS219_RML20_RNA_VM5184_OBJ) \
	$(PASS219_VM81_AUTHORITY_EXPORT_MAP)

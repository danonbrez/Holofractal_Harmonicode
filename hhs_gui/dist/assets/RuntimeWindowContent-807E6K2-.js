const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HHSCalculatorSurface-DAC56tfP.js","assets/main-OSlVFEii.js","assets/index-DYGEw1pb.js","assets/main-DaeEf1kd.css","assets/HHSCalculatorGraphProjection-CVMr47wV.js","assets/HHSRuntimeBreadboard-Bbnf02mz.js","assets/HHSRuntimeTransportOverlay-SaO1mIt0.js"])))=>i.map(i=>d[i]);
import{_ as l}from"./index-DYGEw1pb.js";import{j as n,r as c,R as s}from"./main-OSlVFEii.js";async function a(e,r){try{return await e()}catch(t){return console.error("[RuntimeWindowContent] optional runtime surface missing",t),{default:r}}}const d=s.lazy(()=>a(()=>l(()=>import("./HHSCalculatorSurface-DAC56tfP.js"),__vite__mapDeps([0,1,2,3])),v)),x=s.lazy(()=>a(()=>l(()=>import("./HHSCalculatorGraphProjection-CVMr47wV.js"),__vite__mapDeps([4,1,2,3])),g)),f=s.lazy(()=>a(()=>l(()=>import("./HHSRuntimeBreadboard-Bbnf02mz.js"),__vite__mapDeps([5,1,2,3])),_)),m=s.lazy(()=>a(()=>l(()=>import("./HHSRuntimeTransportOverlay-SaO1mIt0.js"),__vite__mapDeps([6,1,2,3])),w)),R=({runtimeOS:e,applicationId:r})=>r==="runtime_console"?n.jsx(p,{runtimeOS:e}):r==="calculator"?n.jsx(c.Suspense,{fallback:n.jsx(i,{label:"calculator"}),children:n.jsxs("div",{className:`
                        w-full
                        h-full
                        grid
                        grid-cols-2
...
//# sourceMappingURL=RuntimeWindowContent-807E6K2-.js.map

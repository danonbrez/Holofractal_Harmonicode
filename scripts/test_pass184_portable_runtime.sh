...
checks = {
    ...
    "full_application_target": build["public_application"] == "hhs_backend.runtime_os_application_server:app",
...
grep -F 'HHS_PASS_184_I142_LOCAL_ACCEPTANCE_VERIFIED' \
  "$EVIDENCE_DIR/PASS_184_COMPLETION.json"

echo HHS_PASS_184_I142_LOCAL_ACCEPTANCE_VERIFIED

...
def surface_declaration() -> Dict[str, Any]:
    return {
        ...
        "guards": [
            ...
            "scalar_projection_has_no_runtime_authority",
            "h36_phase_reconstruction",
            "integer_only_q62_pcm64_sine_projection",
        ...
        "rejection_codes": [
            ...
            "REJECT_AUDIO_TYPED_TERNARY_ROLE_DRIFT",
            "REJECT_AUDIO_U72_ZERO_QUOTIENT_WITNESS_LOSS",
            "REJECT_AUDIO_SCALAR_PROJECTION_AUTHORITY",
            "REJECT_AUDIO_H36_RECONSTRUCTION_DRIFT",
...
def manifest() -> Dict[str, Any]:
    return {
        ...
        "h36": {
            ...
            "sine_pcm64": "Q62_INT64_LOOKUP_OVER_72_PHASES",
            "sine_runtime_uses_float": False,
            "sine_projection_runtime_authority": False,
        },
